...
export interface DevTestOptions {
  /** Confirmation identity from the existing Acceptance plan; checked before executing cases. */
  expectedExecutionPlan?: import('../acceptance/acceptance-execution-plan.js').AcceptanceExecutionPlanIdentity;
  markdown?: string;
  docPath?: string;
  feishuUrl?: string;
