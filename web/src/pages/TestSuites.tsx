...
export default function TestSuites(): JSX.Element {
  ...
  return (
    <div>
      <div className="page-title">Test Suites</div>
      ...
      <Card title="新建 Suite">
        <div className="form-row">
          <input placeholder="名称（如 WAN3 1080p 回归）" value={name} onChange={(e) => setName(e.target.value)} />
          <input placeholder="Case IDs（逗号分隔）" value={caseIds} onChange={(e) => setCaseIds(e.target.value)} />
          <input placeholder="Tags（逗号分隔，如 p0,smoke）" value={tags} onChange={(e) => setTags(e.target.value)} />
      ...
      <Card
        ...
        action={<input placeholder="按 Tag 过滤" value={tagFilter} onChange={(e) => setTagFilter(e.target.value)} style={{ width: 140 }} />}
      >
