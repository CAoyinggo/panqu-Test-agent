...
- 新增：`src/core/id.ts`、`src/platform/ops/perf-harness.ts`、`tests/unit/id.test.ts`、`tests/perf/platform-perf.test.ts`、`vitest.perf.config.ts`、`scripts/perf/run-perf.mjs`、`docs/phase29-summary.md`、`perf/baseline.json`（基线产物）。
