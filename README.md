...
> 版本：v4.14.0（AI Test Platform 生产化 + 生产安全加固 + 工程治理 + 性能容量基线 + 覆盖率补齐 + 迁移回滚 + 变异测试 + 环境策略边界 + 断言可视化 + 依赖解耦 + 身份解析统一 + 时序卫生治理 + 非法角色拒绝安全加固 + **QA 工作流产品化：Test Suite / Test Plan / Run Template / Asset Versioning / Collaboration / Report Share / QA Workbench**）｜ 更新：2026-08-19 ｜ 维护：AI 测试智能体
