...
全量测试与 Panqu/打包链路已于 2026-09-09 复核；其他专项统计保留 2026-09-08 的基线。不代表客户业务环境验收通过：

| 检查项 | 结果 |
| --- | --- |
| TypeScript 构建 | `npm run build` 通过 |
| 全量 Vitest | 294 个测试文件通过，4 个跳过 |
| 全量测试用例 | 2903 项通过，19 项跳过 |
| Panqu 专属观察/门禁 | 新增 17 项通过，含独立 HTTP 健康与异常对照 |
| 更新后打包与关键链路复核 | 4 个测试文件、54 项通过 |
...
npm install --save-dev ./test-flow-4.29.3.tgz
